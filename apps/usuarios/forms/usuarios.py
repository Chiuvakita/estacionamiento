...
class UsuarioForm(forms.ModelForm):
    ...
    confirmar_clave = forms.CharField(
        ...
        help_text='Repita la contraseña. Déjelo en blanco para no cambiar.'
    )
...
class RegistroClienteForm(forms.ModelForm):
    ...
    discapacidad = forms.BooleanField(
        ...
        help_text='Marque si tiene alguna discapacidad'
    )
    ...
    class Meta:
        model = Usuario
        fields = ['rut', 'nombre', 'apellidoPaterno', 'apellidoMaterno', 'numeroTelefono', 'discapacidad']
    ...
    def save(self, commit=True):
        ...
        usuario.rol = 'Cliente'  # Forzar rol como Cliente
        
        if commit:
            usuario.setClave(self.cleaned_data['clave'])
            usuario.save()
        return usuario